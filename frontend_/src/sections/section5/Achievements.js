...
const Achievements = () => {
  ...
  const content = "These can showcase my Enthusiasm for learning and leveling up skills based on current trends";
  ...
  return (
    <div className="relative flex flex-col items-center justify-between w-full mb-10">
      ...
      <div className={`
      w-[90%] px-[10%] flex flex-row justify-around items-center rounded-xl z-10
